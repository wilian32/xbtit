<form action="<tag:frm_action />" name="requests" method="post">
  ...
  <else:nodb>
    ...
    <tr>
      ...
      <td class="lista"><input type="checkbox" name="enabled" <tag:xtd.ENABLED /> /></td>
      <td class="header"><tag:language.KHEZ_UNINSTALL_DB /></td>
      <td class="lista"><input type="submit" name="confirm" class="btn" value="<tag:language.HACK_UNINSTALL />" /></td>
    </tr>
    <tr>
